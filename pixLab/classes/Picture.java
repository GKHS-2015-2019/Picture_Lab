...
public class Picture extends SimplePicture 
{
   ...
   /** Method to set the colors to 255 minus the current value*/
   public void negate() {
      Pixel[][] pixels = this.getPixels2D();
      for (Pixel[] rowArray : pixels) {
         for (Pixel pixelObj : rowArray){
   ...
   public void grayScale() {
      ...
      for (Pixel[] rowArray : pixels) {
         for (Pixel pixelObj : rowArray){
            average += pixelObj.getRed() + pixelObj.getGreen() + pixelObj.getBlue();
            average = average / 3;
   ...
   /** Method to fix the water view to see fish*/
   ...
   // Horizontal mirror from top to bottom
   ...
   // Diagonal mirrors a section from bottom left to top right around a mirror placed on the diagonal line
   ...
   public void myCollage()
   {
      ...
      flowerNeg.negate();
      Picture swanFlip = new Picture(flower1);
      swanFlip.mirrorVertical();
      
      this.copy(flower1,0,0);
      this.copy(flowerNoBlue,100,0);
      this.copy(flowerNeg, 200, 0);
      ...
      this.copy(flowerNeg,700,0);
      this.copy(flower1,800,0);
      this.mirrorVertical();
